/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  ...
  Datenbasis: Mikrozensus 2013, Scientific Use File
  siehe http://www.gesis.org/missy/metadata/MZ/2013/
...
// cd <DIR>
//
// log using mz13_isced_gml.log, text replace
//
// /* Im folgenden Kommando ist "<mz2013.dta>" durch den lokalen Dateinamen zu
//    ersetzen; ggf. ohne Variablenauswahl - Datenfile ohne User-Missings */
// use EF30  /// Bevoelkerung: Haupt- oder Nebenwohnsitz
//     EF44  /// Alter
//     EF47  /// Geburtsjahr
//     EF287 /// F123 Schule: gegenwärtiger Besuch (i. d. letzten 4 Wochen)
//     EF288 /// F122 Schule: Besuch im letzten Jahr
//     EF289 /// F124 Art der besuchten Schule
//     EF290 /// F125 Art der besuchten allgemeinbildenden Schule (Klassenstufe)
//     EF309 /// F127 Allgemeiner Schulabschluss
//     EF310 /// F128 Höchster allg. Schulabschluss
//     EF311 /// F129 Beruflicher Abschluss
//     EF312 /// F130 Höchster berufl. Abschluss
...
Ab dem Mikrozensus 2013 wird Personen im Alter von 15 Jahren und aelter mit
derzeitigem Besuch einer allgemeinbildenden Schule die Frage zum allgemeinen
Schulabschluss (EF310, Frage 128) nicht mehr gestellt. Die Vergleichbarkeit mit
Ergebnissen des Mikrozensus bis 2012 kann deshalb deshalb eingeschraenkt sein.
