*******************************************************************************************.
*  Gesellschaft sozialwissenschaftlilcher Infrastruktureinrichtungen - GESIS
...
********************************************************************************************.
*
* STATA-Job zur Umsetzung der Bildungsklassifikation ISCED-1997 mit dem Mikrozensus 2004
...
* Datenbasis: Mikrozensus-Scientific Use File 2004
* Datenbeschreibung: http://www.gesis.org/dienstleistungen/daten/amtliche-mikrodaten/mikrozensus/grundfile/mz2004/
*
*******************************************************************************************.
...
recode EF259 0=0 1=4 2 3=5 4 5=6 9=3, generate(as)
replace as=1 if (EF258==8)
replace as=2 if (EF258==9)
replace as=7 if (EF71==1 & EF74==2)
replace as=8 if (EF71==1 & EF74==3)
...
recode EF261 0=0 1 2=4 3 4=5 5 6 7=6 8 9=7 10=8 99=3, generate(ba)
replace ba=1 if EF260==8
replace ba=2 if EF260==9
...
recode EF74 4 5=4 6 7=5 8 9=6 10 11=7 12=8, generate(ba2), if EF71==1 & EF74>=4
recode ba2 99=.
...
recode ba 1 2 3=4 if ba2==4 & ba2> ba
recode ba 1 2 3 4=5 if ba2==5 & ba2>ba
recode ba 1 2 3 4 5=6 if ba2==6 & ba2>ba
recode ba 1 2 3 4 5 6=7 if ba2==7 & ba2>ba
recode ba 1 2 3 4 5 6 7=8 if ba2==8 & ba2>ba
