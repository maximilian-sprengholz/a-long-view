...
Tony Siegel, Delia J�ger, Bernhard Schimpl-Neimanns
Version: 11.06.2013
**************************************************************************** */
...
/* ***************************************************************************
STATA-Job zur Umsetzung der Bildungsklassifikation ISCED-1997 mit dem
Mikrozensus 2006
...
Datenbasis: Mikrozensus-Scientific Use File 2006
...
* Im folgenden Kommando ist "<mz2006>" durch den lokalen Dateinamen
* zu ersetzen; ggf. ohne Variablenauswahl.
// use EF44 EF287 EF288 EF289 EF290 EF291 EF309 EF310 EF311 EF312 using "<mz2006.dta>"
...
die zur Bildung der Variable as=2 "ohne Angabe ob allgemein bildender
...
**************************************************************************** */
recode EF310 (0=0 "entf.") (1=4 "HS/VS/Kl.5-10") ///
             (2 3=5 "RS/POS") (4 5=6 "FHR/ABI/Kl.11-13") ///
...
zusammengefasst.
**************************************************************************** */
recode EF312 (0=0 "Entf�llt (Pers<15)") (1 2=4 "Anlernausb./Praktikum/BVJ") ///
             (3 4=5 "Lehrausb./Berufsfachschule") ///
             (5 6 7=6 "Meister/Technik./Fachschule/Verw.FH") ///
             (8 9=7 "FH/Hochschule") (10=8 "Promotion") ///
...
einer Kindergrippe bzw. eines Kinderhorts' im MZ2005, kann die ISCED-
...
label define is 1 "1B" 2 "1A" 3 "2B" 4 "2A" 5 "3B" 6 "3A" 7 "4A" ///
                8 "5B" 9 "5A" 10 "6" 99 "entf./nicht zuordenbar"
label values is is
tab is, miss
