...
********************************************************************************************.
*
* SPSS-Job zur Umsetzung der Bildungsklassifikation ISCED-1997 mit dem Mikrozensus 1991
* ISCED-Version des German Microdata Lab, GESIS
*
* Zur Beschreibung der Skalenkonstruktion siehe:
...
* Datenbasis: Mikrozensus-Scientific Use File 1991
* Datenbeschreibung: http://www.gesis.org/dienstleistungen/daten/amtliche-mikrodaten/mikrozensus/grundfile/mz1991/
*
*******************************************************************************************.
...
recode ef121 1=4 2 3=5 4 5=6 8=3, generate(as)
replace as=0 if (ef59==8 | ef59==9) & (ef121==8 | ef121==9)
replace as=1 if (ef59==2 & ef121==9)
replace as=3 if (ef59==1 & (ef121==8 | ef121==9)) | /*
*/ (ef59==2 & ef121==8)
...
recode ef122 1=1 2=5 3=4 4 5=6 6 7=7 8 9=0, generate(ba)
...
* keine Unterscheidung m�glich zwischen Lehr- und Anlernausbildung   ***.
* Bedingung: mind. 2-j�hrige Dauer, berufl. Praktikum: mind. 6 Monate) ***.
