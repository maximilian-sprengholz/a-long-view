...
Malte Langeheine, Delia Jaeger, Tony Siegel, Bernhard Schimpl-Neimanns
Version: 14.06.2013
***************************************************************************/
...
gesis_methodenberichte/2006/06_08_Schroedter.pdf?download=true
Programm: http://www.gesis.org/missy/fileadmin/missy/klassifikationen/ISCED/
          ISCED_STATA/mz08_isced_gml.do
...
Datenbasis: Mikrozensus-Scientific Use File 2008
Datenbeschreibung:
   http://www.gesis.org/missy/missy-home/auswahl-datensatz/mikrozensus-2008/
***************************************************************************/
...
* Im folgenden Kommando ist "<mz2008>" durch den lokalen Dateinamen
* zu ersetzen; ggf. mit Variablenauswahl.
// use "<mz2008.dta>", replace
...
zusammengefasst.
***************************************************************************/
recode EF312 (0=0 "Entfaellt (Pers<15)") ///
...
*  keep if (EF287~=1 & EF287~=2)
*  oder z.B.: tab is if (EF287~=1 & EF287~=2)
*
