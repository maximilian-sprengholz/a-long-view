...
// version 12.1     // Stata/MP 12.1 for Windows
//
// clear
// capture log close
// set more off
...
ISCED_STATA/mz09_isced_GML.do/mz10_isced_gml.do
...
http://www.staffs.ac.uk/access-studies/docs/OECD-education-classifications.pdf

Datenbasis: Mikrozensus-Scientific Use File 2010
Datenbeschreibung:
   http://www.gesis.org/missy/missy-home/auswahl-datensatz/mikrozensus-2010/
***************************************************************************/
...
* Im folgenden Kommando ist "<mz2010>" durch den lokalen Dateinamen
...
Im Mikrozensus 2010 werden bei der korrigierten Variablen zum hoechsten allg.
...
Im Mikrozensus 2010 werden bei der korrigierten Variablen zum hoechsten
...
recode EF312k (-3 -5=0 "Entfaellt (Pers<15)") ///
             ...
             (5 6 7 12=6 "Meister/Technik./Fachschule/Verw.FH/Berufsak.") ///
             (8 9=7 "FH/Hochschule") ///
             (10=8 "Promotion") ///
...
***************************************************************************/
generate ba2=.
replace ba2 = 4 if EF289==11 | EF289==13 | EF289==14 | EF289==09 ///
                   & ((EF287>=1 & EF287<=2) | EF288==1)
replace ba2 = 5 if EF289==10 | EF289==12 ///
                   & ((EF287>=1 & EF287<=2) | EF288==1)
replace ba2 = 6 if EF289>=15 & EF289<=18 ///
				   & ((EF287>=1 & EF287<=2) | EF288==1)
replace ba2 = 7 if EF289==19 | EF289==20 ///
                   & ((EF287>=1 & EF287<=2) | EF288==1)
replace ba2 = 8 if EF289==21 ///
				   & ((EF287>=1 & EF287<=2) | EF288==1)
