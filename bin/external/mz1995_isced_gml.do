...
********************************************************************************************.
*
* STATA-Job zur Umsetzung der Bildungsklassifikation ISCED-1997 mit dem Mikrozensus 1995
...
* Datenbasis: Mikrozensus-Scientific Use File 1995
* Datenbeschreibung: http://www.gesis.org/dienstleistungen/daten/amtliche-mikrodaten/mikrozensus/grundfile/mz1995/
*
*******************************************************************************************.
...
recode ef121 1=4 2 3=5 4 5=6 9=0, generate(as)
replace as=1 if (ef59==9)
replace as=3 if (ef59==1 & ef121==9)
replace as=7 if (ef56==2 & ef121==9)
replace as=8 if (ef56==3)
...
recode ef122 1=1 2=5 3=4 4 5=6 6 7=7 9=0, generate(ba)
...
* Bedingung: mind. 2-j�hrige Dauer, berufl. Praktikum: mind. 1 Jahr) ***.
...
recode ef56 4=5 5 6=7, generate(ba2), if ef56>=4 & ef56<=6
...
recode ba 0 1 4=5 if ba2==5 & ba2>ba
recode ba 0 1 4 5 6=7 if ba2==7 & ba2>ba
...
replace is=2 if ((ef56==1 | ef56==9) & ef23<=14)
replace is=3 if ((as==0 | as==1) & ba==4) | ((as==3 | as==4) /*
*/ & (ba==0 | ba==1 | ba==4))
