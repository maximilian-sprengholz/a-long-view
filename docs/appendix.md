...
To model labor market outcomes over time for first generation immigrants in Germany, we distinguish between __arrival year cohorts__. These correspond to the following years of arrival:
